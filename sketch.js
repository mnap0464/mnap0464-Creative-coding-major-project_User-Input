...
function preload() {
  backgroundMusic = loadSound('assets/assets_Chick_Corea.mp3'); //loads the main background jazz tune.

  //sets up  for all the individual instrument sounds.
  instrumentSounds = {
    A: loadSound('assets/trumpetc2.wav'), //sound for the 'A' key (trumpet).
    S: loadSound('assets/611945__szegvari__walking-jazz-guitar-solo-retro-cinematic-music-surround.wav'), //sound for the 'S' key (guitar).
    D: loadSound('assets/violin_pluck.wav'), //sound for the 'D' key (violin).
    F: loadSound('assets/drum-loop-1.wav') //sound for the 'F' key (drum).
  }
